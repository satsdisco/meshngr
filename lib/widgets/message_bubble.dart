      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      // Route info for received messages
                      if (!message.isMe && message.route != null) ...[
                        Icon(Icons.route, size: 11, color: AppColors.textTertiary.withValues(alpha: 0.6)),
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  child: Row(
                    mainAxisSize: MainAxisSize.min,
                    children: [
                      const Icon(Icons.refresh, size: 13, color: AppColors.error),
                      const SizedBox(width: 4),
                      Text(
            ...
            // Route visualization for sent messages
            if (message.isMe && message.route != null && message.route!.hopCount > 0) ...[
  ...
  Widget build(BuildContext context) {
    switch (status) {
      ...
      case DeliveryStatus.sent:
        return Icon(Icons.done, size: 14, color: Colors.white.withValues(alpha: 0.5));
